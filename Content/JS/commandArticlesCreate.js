{
    ...
    const addTableArticle = (articleName, articleQuantity, unityCode, articleUnityText) => {
        ...
        nameInputCell.setAttribute('data-type', 'name');
        nameInputCell.style.display = 'none';
        var nameInput = document.createElement('input');
        nameInput.value = articleName;
        nameInputCell.appendChild(nameInput);
        var quantityCell = document.createElement('td');
        var quantityInputCell = document.createElement('td');
        quantityInputCell.setAttribute('data-type', 'quantity');
        quantityInputCell.style.display = 'none';
        ...
        unityCodeCell.style.display = 'none';
